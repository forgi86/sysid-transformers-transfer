...
from dataset import PWHDataset, seed_worker
...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument('--nx', type=int, default=40, metavar='N',
    ...
    train_ds = PWHDataset(nx=cfg.nx, nu=cfg.nu, ny=cfg.ny, seq_len=cfg.seq_len_ctx+cfg.seq_len_new,
    ...
    val_ds = PWHDataset(nx=cfg.nx, nu=cfg.nu, ny=cfg.ny, seq_len=cfg.seq_len_ctx+cfg.seq_len_new,
